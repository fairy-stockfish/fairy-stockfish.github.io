...
If you are not familiar with NNUE yet, see the [introduction in the wiki](https://github.com/ianfab/Fairy-Stockfish/wiki/NNUE) for more information. After downloading an NNUE network you need to set the `EvalFile` parameter in Fairy-Stockfish as described in the [wiki](https://github.com/ianfab/Fairy-Stockfish/wiki/Settings#evalfile) to enable it.

### Current best NNUE networks

This is an alphabetical list of current best variant [NNUE](https://github.com/ianfab/Fairy-Stockfish/wiki/NNUE) networks available at [this google drive folder](https://drive.google.com/drive/folders/1m5PpiI3Kjzk_ow7F5RkwKnbO0Td-qb9J?usp=sharing) that are compatible with the latest Fairy-Stockfish release and development version. 
...
| bughouse  | [bughouse-a53140c72ba2.nnue](https://drive.google.com/u/0/uc?id=1rWCM32j5GQ0xZS0Ofj0jnQCfeCQGBPKQ&export=download) | [+338](https://www.patreon.com/posts/57647583) | | Fabian Fichter |
